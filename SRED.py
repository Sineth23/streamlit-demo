...
1. *Use Only Provided Information:*
   ...
   - *Relevant Repository Only:* Focus exclusively on the repository being investigated. If the Jira analysis contains information from other repositories, only use the relevant parts applicable to the current repository.
...
3. *Reference Specific Code Examples and Jira Tickets:*
   ...
   - *Jira Tickets:* Reference relevant Jira tickets from the analysis that apply to the repository, ensuring they are accurately represented.
   - *Features and Modules:* Reference particular features, modules, or components developed.
   - *Development Process:* Describe the iterative process, including experiments, testing, and refinements.
...
class QueryCodebase:
    ...
    def _create_vectorstore(self) -> DeepLake:
...
if __name__ == '__main__':
    #dataset_path = 'deeplake_datasetB1'
    dataset_path = 'waio-portal-backend1'
    ...
    while True:
        ...
        try:
            query_codebase.perform_query(query_text, section_name)
